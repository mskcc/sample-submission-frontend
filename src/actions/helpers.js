    ...
    switch (patientIDType) {
      ...
      case 'Non-MSK Patients':
        return {
          ...
          error:
            'Invalid format. Please use at least four alpha-numeric characters and no spaces. Dashes and underscores are allowed. Every 8 digit ID is considered a MRN.',
        }
